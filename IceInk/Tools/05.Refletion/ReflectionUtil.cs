...
#pragma warning disable 1591
        public static BindingFlags bf = BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.NonPublic |
...
#pragma warning restore 1591
        ...
        public static string GetDescription(this Enum value, params object[] args)
        {
            ...
            if (args != null && args.Length > 0) return string.Format(null, text1, args);
        ...
        public static object GetAttribute(this Type attributeType, MemberInfo type, bool searchParent)
        {
            ...
            if (!attributeType.IsSubclassOf(typeof(Attribute))) return null;
        ...
        public static object[] GetAttributes(this Type attributeType, MemberInfo type, bool searchParent)
        {
            ...
            if (type.IsDefined(attributeType, false)) return type.GetCustomAttributes(attributeType, searchParent);
        ...
        /// <returns></returns>
        public static T GetInstance<TArg1, TArg2, T>(this Type type, TArg1 argument1, TArg2 argument2)
            where T : class, new()
        {
        ...
        /// <param name="argument2">参数值</param>
        /// <returns></returns>
        public static T GetInstance<TArg1, TArg2, T>(string type, TArg1 argument1, TArg2 argument2)
            where T : class, new()
        {
        ...
        /// <returns></returns>
        public static T GetInstance<TArg1, TArg2, TArg3, T>(this Type type, TArg1 argument1, TArg2 argument2,
            TArg3 argument3) where T : class, new()
        {
            return InstanceCreationFactory<TArg1, TArg2, TArg3, T>.CreateInstanceOf(type, argument1, argument2,
                argument3);
        }
        ...
        /// <param name="argument3">参数值</param>
        /// <returns></returns>
        public static T GetInstance<TArg1, TArg2, TArg3, T>(string type, TArg1 argument1, TArg2 argument2,
            TArg3 argument3) where T : class, new()
        {
            return InstanceCreationFactory<TArg1, TArg2, TArg3, T>.CreateInstanceOf(Type.GetType(type), argument1,
                argument2, argument3);
        }
        ...
        private static class InstanceCreationFactory<TArg1, TArg2, TArg3, TObject> where TObject : class, new()
        {
            private static readonly Dictionary<Type, Func<TArg1, TArg2, TArg3, TObject>> InstanceCreationMethods =
                new Dictionary<Type, Func<TArg1, TArg2, TArg3, TObject>>();
            ...
            private static void CacheInstanceCreationMethodIfRequired(Type type)
            {
                ...
                var constructor = type.GetConstructor(BindingFlags.Instance | BindingFlags.Public, null,
                    CallingConventions.HasThis, constructorArgumentTypes, Array.Empty<ParameterModifier>());
                ...
                var constructorCallingLambda = Expression
                    .Lambda<Func<TArg1, TArg2, TArg3, TObject>>(constructorCallExpression, lamdaParameterExpressions)
                    .Compile();
