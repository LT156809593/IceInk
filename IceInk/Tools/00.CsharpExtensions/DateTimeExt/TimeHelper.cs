...
namespace IceInk
{
    ...
    public static class TimeHelper
    {
        ...
        {
            if (dt.Equals(DBNull.Value)) return GetFormatDate(DateTime.Now, separator);

            var tem = $"yyyy{separator}MM{separator}dd";
        ...
        public static string GetFormatTime(this DateTime dt, char separator)
        {
            ...
            var tem = $"hh{separator}mm{separator}ss";
            return dt.ToString(tem);
        }
        ...
        public static string DateConvert(this string strDateTime)
        {
            ...
            strDateTime = strDateTime.Replace("-0700", "GMT");
            strDateTime = strDateTime.Replace("-0800", "GMT");
            var dt = DateTime.Parse(strDateTime, null, DateTimeStyles.AdjustToUniversal);
            return dt.ToString();
        }
