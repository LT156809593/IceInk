    ...
    public static partial class SystemInfo
    {
        ...
        public static List<EkCpuInfo> GetCpuInfo()
        {
            try
            {
                ...
                return _cpuObjects.Select(mo => new EkCpuInfo
                {
                    CpuLoad = CpuLoad,
...
#pragma warning disable 1591
        ...
        [DllImport("kernel32")]
        public static extern void GlobalMemoryStatus(ref EkMemoryInfo meminfo);

        [DllImport("kernel32")]
        public static extern void GetSystemTime(ref EkSystemTimeInfo stinfo);
